...
local function maxRead(w,c,str)
	...
	while true do --main loop
		...
		elseif e == ("mouse_click") and (type(cx) == "number") and (type(cy) == "number") then
...
while true do
	local e,_,x,y = os.pullEventRaw("mouse_click")
	if (e == "mouse_click") and (type(x) == "number") and (type(y) == "number") then
